...
export class CartPage implements OnInit {
    ...
    this.authService.MyCartItems(data).subscribe(
      (res: any) => {
        ...
        if (res.error === false) {
          ...
          this.grandTotal = res.result_viewCart.cart_items.header.total_price;
  ...
  Delete(product_id, color_id, size_id) {
  ...
  addQuantity(product_id, j, pp, qty, color_id, size_id) {

    console.log('Update Cart Data => ' + product_id, j, pp, qty, color_id, size_id);
  ...
  minusQuantity(product_id, i, pp, qty, color_id, size_id) {
    console.log('Update Cart Data => ' + product_id, i, pp, qty, color_id, size_id);
